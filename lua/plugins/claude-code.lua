return {
  ...
  config = function()
    require("claude-code").setup({
      ...
      window = {
        ...
        -- Floating window configuration (uncomment and set position = "float" to use)
        float = {
  ...
  -- Lazy loading - load when any of these commands are used
  cmd = {
    "ClaudeCode",
    "ClaudeCodeContinue", 
    "ClaudeCodeResume",
